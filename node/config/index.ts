...
export const AWS_S3_BUCKET_IMAGE_FOLDER = process.env.AWS_S3_BUCKET_IMAGE_FOLDER;
export const AWS_S3_BUCKET_AVATAR_FOLDER = process.env.AWS_S3_BUCKET_AVATAR_FOLDER;
export const AWS_S3_BUCKET_IDENTIFICATION_FOLDER = process.env.AWS_S3_BUCKET_IDENTIFICATION_FOLDER;